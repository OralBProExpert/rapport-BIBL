...
\begin{itemize}
  \item \textbf{Communication} : Ils fournissent une visualisation intuitive des scénarios d'attaque, facilitant la compréhension et la communication entre les parties prenantes, y compris les experts en sécurité, les développeurs et les gestionnaires.
...
\subsubsection{Analyse quantitative : arbres vs graphes d'attaque}
