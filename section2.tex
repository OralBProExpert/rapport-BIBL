...
% TODO: Parler des feuilles plutôt que des traces
\begin{itemize}
...
\begin{definition}[Graphe d'attaque étiqueté]
  Un graphe d'attaque étiqueté est un tuple $(S, \delta, S_0, S_s)$, où $S$, $S_0$ et $S_s$ sont définis comme pour un graphe d'attaque classique, et $\delta : S \times \mathbb{B} \rightarrow S$ est une fonction de transition étiquetée par des éléments de $\mathbb{B}$, représentant les actions de l’attaquant.
\end{definition}
